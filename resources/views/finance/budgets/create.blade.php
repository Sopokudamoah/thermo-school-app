...
@section('page-title', 'Create Annual Budget')

@section('content')

    <div class="mb-6">
        <h1 class="font-heading text-xl font-bold text-gray-900">Create Annual Budget</h1>
        <nav class="flex items-center gap-1.5 mt-1 text-sm text-gray-500">
            ...
            <i data-lucide="chevron-right" class="w-3.5 h-3.5"></i>
            <span class="text-gray-900">Create Budget</span>
        </nav>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" min="0" id="total_allocated" name="total_allocated"
                               value="{{ old('total_allocated') }}" placeholder="0.00" required
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="3" placeholder="Enter budget notes..."
                              class="block w-full rounded-lg border border-gray-300 px-3.5 py-2.5 text-sm text-gray-900 focus:outline-none focus:border-indigo-500 transition-colors">{{ old('notes') }}</textarea>
                </div>
                ...
                <div class="flex items-center gap-3 pt-2">
                    <button type="submit"
                        ...
                        <i data-lucide="save" class="w-4 h-4"></i> Create & Continue
                    </button>
