...
@section('content')
    ...
    <div class="mb-6">
        <h1 class="font-heading text-xl font-bold text-gray-900">Add Discount</h1>
        <nav class="flex items-center gap-1.5 mt-1 text-sm text-gray-500">
            ...
            <i data-lucide="chevron-right" class="w-3.5 h-3.5"></i>
            <span class="text-gray-900">Add Discount</span>
        </nav>
    </div>
        ...
        <form action="{{ route('finance.discounts.store') }}" method="POST">
            ...
            <div class="space-y-4 mb-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="value" class="block text-sm font-medium text-gray-700 mb-1.5">Value <sup
                                class="text-indigo-500">*</sup></label>
                        <input type="number" step="0.01" min="0" id="value" name="value" value="{{ old('value') }}"
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3" placeholder="Enter discount description..."
                              class="block w-full rounded-lg border border-gray-300 px-3.5 py-2.5 text-sm text-gray-900 focus:outline-none focus:border-indigo-500 transition-colors">{{ old('description') }}</textarea>
                </div>
            ...
            <div class="flex items-center gap-3">
                <button type="submit"
                    ...
                    <i data-lucide="save" class="w-4 h-4"></i> Save Discount
                </button>
                <a href="{{ route('finance.discounts.index') }}"
