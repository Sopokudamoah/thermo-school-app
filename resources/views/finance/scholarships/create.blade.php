...
@section('page-title', 'Add Scholarship Type')

@section('content')

    <div class="mb-6">
        <h1 class="font-heading text-xl font-bold text-gray-900">Add Scholarship Type</h1>
        <nav class="flex items-center gap-1.5 mt-1 text-sm text-gray-500">
            ...
            <i data-lucide="chevron-right" class="w-3.5 h-3.5"></i>
            <span class="text-gray-900">Add Scholarship Type</span>
        </nav>
    </div>
        ...
        <form action="{{ route('finance.scholarships.store') }}" method="POST">
            ...
            <div class="flex items-center gap-3">
                <button type="submit"
                    ...
                    <i data-lucide="save" class="w-4 h-4"></i> Save Scholarship Type
                </button>
